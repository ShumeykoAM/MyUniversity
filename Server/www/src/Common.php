<?php
  ...
  namespace E_MESSAGEID
  {
    ...
    const GET_ENTITY_T                = 10; //Отправить измененную таблицы на синхронизации
    const GET_ENTITY_N                = 11; //Отправить отсутствующую у клиента запись таблицы для синхронизации
    const GET_SERVER_TIME             = 12; //Получить время сервера

            ...
            if(acpf.isCreated)
            {
              ...
              SQLTransaction sqlt = new SQLTransaction(db, new I_Transaction(){
                ...
                public boolean trnFunc()
                {
                  ...
                  count = db.update(Purchase.table_name, values, "_id_user_account = 1", null);
                  count = db.update(Type.table_name, values, "_id_user_account = 1", null);
                  count = db.update(Detail.table_name, values, "_id_user_account = 1", null);
                  count = db.update(Chronological.table_name, values, "_id_user_account = 1", null);
                  return true;
                }
              });
